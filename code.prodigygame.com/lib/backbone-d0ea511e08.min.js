! function(t) {
    ...
    var a = function(t, e, n) {
            i.each(e, (function(e, s) {
                i[s] && (t.prototype[s] = function(t, e, n) {
                    switch (t) {
                        case 1:
                            return function() {
                                return i[e](this[n])
                        ...
                        case 3:
                            return function(t, s) {
                                return i[e](this[n], o(t, this), s)
                            };
                        case 4:
                            return function(t, s, r) {
                                return i[e](this[n], o(t, this), s, r)
                            };
                        default:
                            return function() {
        ...
        l = function(t, e, n, s, r) {
            ...
            if (n && "object" == typeof n) {
                ...
                for (a = i.keys(n); o < a.length; o++) e = l(t, e, a[o], n[a[o]], r)
            } else if (n && c.test(n))
                for (a = n.split(c); o < a.length; o++) e = t(e, a[o], s, r);
            else e = t(e, n, s, r);
            return e
        };
    u.on = function(t, e, i) {
    ...
    u.off = function(t, e, i) {
        return this._events ? (this._events = l(g, this._events, t, e, {
            context: i,
    ...
    u.trigger = function(t) {
        ...
        return l(v, this._events, t, void 0, i), this
    };
    var v = function(t, e, i, n) {
            if (t) {
                var s = t[e],
                    r = t.all;
                s && r && (r = r.slice()), s && m(s, n), r && m(r, [e].concat(n))
            }
            return t
        },
        m = function(t, e) {
    ...
    i.extend(_.prototype, u, {
        ...
        set: function(t, e, n) {
            ...
            if (this.idAttribute in s && (this.id = this.get(this.idAttribute)), !a) {
        ...
        save: function(t, e, n) {
            ...
            }, O(this, n), s && r && (this.attributes = i.extend({}, h, s));
        ...
        destroy: function(t) {
            ...
            var a = !1;
            return this.isNew() ? i.defer(t.success) : (O(this, t), a = this.sync("delete", this, t)), s || r(), a
        },
        url: function() {
                ...
                for (a = 0; a < t.length; a++) {
                    ...
                    if (_) {
                        if (f && r !== _) {
                            ...
                            e.parse && (y = _.parse(y, e)), _.set(y, e), u.push(_), v && !p && (p = _.hasChanged(m))
                        }
                        l[_.cid] || (l[_.cid] = !0, o.push(_)), t[a] = _
                    } else d && (r = t[a] = this._prepareModel(r, e)) && (h.push(r), this._addReference(r, e), l[r.cid] = !0, o.push(r))
                }
                if (g) {
                    for (a = 0; a < this.length; a++) l[(r = this.models[a]).cid] || c.push(r);
                    c.length && this._removeModels(c, e)
                }
                var x = !1,
                    E = !v && d && g;
                if (o.length && E ? (x = this.length !== o.length || i.some(this.models, (function(t, e) {
                        return t !== o[e]
                    })), this.models.length = 0, w(this.models, o, 0), this.length = this.models.length) : h.length && (v && (p = !0), w(this.models, h, null == s ? this.length : s), this.length = this.models.length), p && this.sort({
                        silent: !0
                    }), !e.silent) {
                    for (a = 0; a < h.length; a++) null != s && (e.index = s + a), (r = h[a]).trigger("add", r, this, e);
                    (p || x) && this.trigger("sort", this, e), (h.length || c.length || u.length) && (e.changes = {
                        added: h,
                        removed: c,
                        merged: u
    ...
    i.extend(E.prototype, u, {
        ...
        if (s.url || (a.url = i.result(n, "url") || M()), null != s.data || !n || "create" !== t && "update" !== t && "patch" !== t || (a.contentType = "application/json", a.data = JSON.stringify(s.attrs || n.toJSON(s))), s.emulateJSON && (a.contentType = "application/x-www-form-urlencoded", a.data = a.data ? {
                model: a.data
    ...
    i.extend(T.prototype, u, {
        ...
        _routeToRegExp: function(t) {
            return t = t.replace(A, "\\$&").replace(P, "(?:$1)?").replace(H, (function(t, e) {
                return e ? t : "([^/?]+)"
    ...
    var C = e.History = function() {
        ...
        j = /^\/+|\/+$/g,
        N = /#.*$/;
    C.started = !1, i.extend(C.prototype, u, {
        interval: 50,
        atRoot: function() {
    ...
    _.extend = y.extend = T.extend = E.extend = C.extend = function(t, e) {
        var n, s = this;
